...
?>
                                  ...
                                  <td><?= $continent_name . "<br>" . $country_name; ?></td>
                                  <td><?= $regional_name . "<br>" . $state_name; ?></td> 
                                  <td>
...
/*    console.log("franch_commission ",franch_commission);
    ...
    if(verifyotp2 ==""){
        ...
        $.post("ajax_approveVerifyOtp.php", {request_id: verify_referal_id,franch_commission : franch_commission,verifyto:verifyto, verifyotp1 : verifyotp1,verifyotp2 : verifyotp2, agreed_amount : agreed_amount  }, function(resultdata){
            console.log("response data : ",resultdata);
            if(resultdata == 1){
