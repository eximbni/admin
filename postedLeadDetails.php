				...
				<div class="card">
					...
					<div class="card-body">
    					...
    					<div class="row">
    						...
    						<div class="col-4">
    						    <label>International Quality Certification Agency</label>
    						    <div class="col-8">
    						      <?= $lead_id; ?>  
    						    </div>
    						</div>
    						<div class="col-4">
    						    <label>Remarks/ Quality Assessment </label>
    						    <div class="col-8">
    						      <?= $posted_date; ?>  
    						    </div>
    						</div>			
