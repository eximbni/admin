			...
			<div class="content-wrapper"   >
				<section class="content-header">
				  <div class="container-fluid">
					...
					<div class="row mb-2">
					  <div class="col-sm-12">
						<h4 style="text-align:center;"><b>Lead Request</b></h4>
					  </div>
					</div>
				  </div><!-- /.container-fluid -->
    				...
    				<table id="example1" class="table table-bordered table-striped">
    					...
    					?>
    							<tr> 
    								...
    								<!--td><?php echo $row_pend['english']?></td-->
    								...
    								<?php }else{ ?>
    							   	<td><button type="button" data-toggle="modal" data-target="#exampleModal" id="<?php echo $row_pend['id']; ?>" onclick="approve_lead(this.id)" class="btn btn-outline-success btn-sm">Apporve</button> </td>
    								<?php } ?><td>
    								 <button type="button" data-toggle="modal" data-target="#exampleModal1" id="<?php echo $row_pend['id']; ?>" onclick="reject_lead(this.id)" class="btn btn-outline-danger btn-sm">  Reject</button> </td>
