			...
			<div class="content-wrapper">
				<section class="content-header">
				  <div class="container-fluid">
					<div class="row mb-2">
					  <div class="col-sm-12">
						<ol class="breadcrumb float-sm-left">
						  ...
						  <li class="breadcrumb-item active">All Lead Reports</li>
						</ol>
						<?php echo $message; ?>
					  </div>
					</div>
					<div class="row mb-2">
					  <div class="col-sm-12">
						<h4 style="text-align:center;"><b>All Lead Reports</b></h4>
					  </div>
					</div>
				  </div><!-- /.container-fluid -->
					  ...
					  <table id="example1" class="table table-bordered table-striped">
						...
						<tbody >
							...
							if(isset($_POST['search']))
							{
								...
								$sql_leads = "select l.* from leads l, countries c, lead_display_countries ldc where l.status=1 and l.country_id = c.country_id and l.id=ldc.lead_id $conti $regi $count $ldtype $ldcount";
