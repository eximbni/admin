			...
			<div class="content-wrapper">
				<section class="content-header">
				  <div class="container-fluid">
					...
					<div class="row mb-2">
					  <div class="col-sm-12">
						<h6 style="text-align:center;"><b>Webinar List</b></h6>
					  </div>
					</div>
				  </div><!-- /.container-fluid -->
			   ...
			   <div class="card-body" style="overflow:scroll" >
					  <table id="example1" class="table table-bordered table-striped">
						...
						?>	
							  ...
							  <td align="center"><?= $row['webinar_date']." ".$row['webinar_time']; ?></td>
							  ...
							  <td align="left"><?= $row['description'];?></td>
							  	...
							  	?>
							  		...
							  		<td> <a class="btn btn-success" href="webinar_participate.php?id=<?php echo $row['id']; ?>">Invite Users</a> </td>
							  	<?php 	
							  		}else{
							  	?>
							  		<td> Completed </td>
							  		<td> <a class="btn btn-success" href="webinar_participate.php?id=<?php echo $row['id']; ?>">Joined Users</a></td>
